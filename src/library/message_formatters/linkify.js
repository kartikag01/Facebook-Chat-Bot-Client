...
// Output from the Closure Compiler
  var module$$linkify$core$state = {}, _inherits$$module$$linkify$core$state = function (b, a) {
    ...
    _prototypeProperties$$module$$linkify$core$state(b, null, {
      on        :{
        value      :function (a, b) {
    ...
    _prototypeProperties$$module$$linkify$core$state(a, null, {
      test:{
        value      :function (a, b) {
  ...
  var module$$linkify$core$tokens = {}, _get$$module$$linkify$core$tokens = function get(a, c, f) {
    ...
    _prototypeProperties$$module$$linkify$core$tokens(b, {
      test:{
        value      :function (a) {
    ...
    _inherits$$module$$linkify$core$tokens(a, b);
    return a;
  }(TextToken$$module$$linkify$core$tokens), text$$module$$linkify$core$tokens = {
    Base    :TextToken$$module$$linkify$core$tokens, DOMAIN:DOMAIN$$module$$linkify$core$tokens,
    AT      :AT$$module$$linkify$core$tokens, COLON:COLON$$module$$linkify$core$tokens,
    DOT     :DOT$$module$$linkify$core$tokens, LOCALHOST:LOCALHOST$$module$$linkify$core$tokens,
    NL      :NL$$module$$linkify$core$tokens, NUM:NUM$$module$$linkify$core$tokens,
    PLUS    :PLUS$$module$$linkify$core$tokens, POUND:POUND$$module$$linkify$core$tokens,
    QUERY   :QUERY$$module$$linkify$core$tokens,
    PROTOCOL:PROTOCOL$$module$$linkify$core$tokens, SLASH:SLASH$$module$$linkify$core$tokens,
    SYM     :SYM$$module$$linkify$core$tokens, TLD:TLD$$module$$linkify$core$tokens, WS:WS$$module$$linkify$core$tokens
  };
  ...
  var MultiToken$$module$$linkify$core$tokens = function () {
    ...
    _inherits$$module$$linkify$core$tokens(a, b);
    _prototypeProperties$$module$$linkify$core$tokens(a, null, {
      toHref:{
        value      :function () {
    ...
    return a;
  }(MultiToken$$module$$linkify$core$tokens), multi$$module$$linkify$core$tokens = {
    Base:MultiToken$$module$$linkify$core$tokens, EMAIL:EMAIL$$module$$linkify$core$tokens,
    NL  :NL$$module$$linkify$core$tokens, TEXT:TEXT$$module$$linkify$core$tokens, URL:URL$$module$$linkify$core$tokens
  };
  ...
  var run$$module$$linkify$core$parser = function (b) {
    ...
    State:State$$module$$linkify$core$parser, TOKENS:MULTI_TOKENS$$module$$linkify$core$parser,
    run  :run$$module$$linkify$core$parser, start:S_START$$module$$linkify$core$parser
  };
